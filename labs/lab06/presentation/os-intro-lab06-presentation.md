...
![tmp и домашний каталог](image/4.1.png){#fig:001 width=70%}

---

С разными флагами использую команду ls. ([рис. @fig-002])

![Использование команды ls](image/4.2.png){#fig:002 width=70%}

---

Проверяю, есть ли подкаталог cron в /var/spool. ([рис. @fig-003])

![Проверка подкаталога](image/4.3.png){#fig:003 width=70%}

---

Проверяю права доступа в домашнем каталоге. ([рис. @fig-004])

![Права доступа в домашнем каталоге](image/4.4.png){#fig:004 width=70%}

---

Играюсь с папками. ([рис. @fig-005])

![Создание и удаление каталогов](image/4.5.png){#fig:005 width=70%}
